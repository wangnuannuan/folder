...
//返回值:写入的情况
u8
STMFLASH_WriteHalfWord(u32 faddr, u16 dat)
{
	u8 res;
...
//返回值:对应数据.
u16
STMFLASH_ReadHalfWord(u32 faddr)
{
	return *(vu16 *) faddr;
}
...
//NumToWrite:半字(16位)数   
void
STMFLASH_Write_NoCheck(u32 WriteAddr, u16 * pBuffer, u16 NumToWrite)
{
	u16 i;
...
//WriteData:要写入的数据
void
Test_Write(u32 WriteAddr, u16 WriteData)
{
