...
//    其他,初始化失败;
u8
CAN1_Mode_Init(u8 tsjw, u8 tbs2, u8 tbs1, u16 brp, u8 mode)
{
	u16 i = 0;
...
u8
CAN1_Tx_Msg(u32 id, u8 ide, u8 rtr, u8 len, u8 * dat)
{
	u8 mbox;
	if (CAN1->TSR & (1 << 26))
		mbox = 0;	//邮箱0为空
...
//dat:数据缓存区
void
CAN1_Rx_Msg(u8 fifox, u32 * id, u8 * ide, u8 * rtr, u8 * len, u8 * dat)
{
...
u8
CAN1_Send_MsgTEST(u8 * msg, u8 len)
{
	u8 mbox;
	u16 i = 0;
