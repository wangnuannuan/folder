...
//Offset:偏移量
void
MY_NVIC_SetVectorTable(u32 NVIC_VectTab, u32 Offset)
{
...
void
MY_NVIC_Init(u8 NVIC_PreemptionPriority, u8 NVIC_SubPriority,
...
//该函数会自动开启对应中断,以及屏蔽线
void
Ex_NVIC_Config(u8 GPIOx, u8 BITx, u8 TRIM)
{
	u8 EXTADDR;
	u8 EXTOFFSET;
